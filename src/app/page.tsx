...
export default function Home() {
  ...
  return (
    <div className="min-h-screen p-4 md:p-8 pb-6 md:pb-20 font-[family-name:var(--font-geist-sans)] text-green-500">
      <main className="flex flex-col md:flex-row w-full row-start-2 h-full items-stretch gap-4">
        ...
        <div className="flex-1 bg-gray-800 rounded-4xl border border-purple-900/50 overflow-hidden flex 
                        h-[calc(100vh-160px)] md:h-[calc(100vh-200px)] md:ml-[50px]">
